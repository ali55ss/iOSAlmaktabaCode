        ...
        for (UIWindow *window in frontToBackWindows) {
            ...
            if(windowOnMainScreen && windowIsVisible && windowLevelSupported) {
             //   [window addSubview:self.overlayView];
                ...
                //UIView *subView = [windowViews firstObject];
                UIView *subView = [[[UIApplication sharedApplication] delegate] window];
                [subView addSubview:self.overlayView];
...
#else
    _overlayView.frame = [[[UIApplication sharedApplication] delegate] window].bounds;
#endif
