...
@interface IRLScannerViewController : UIViewController<UIGestureRecognizerDelegate>

{
    IBOutlet UIButton * btnGallery;
    IBOutlet UIButton *btnGallery1;
    IBOutlet UIButton *btngallery2;
    
    
    
    IBOutlet UIButton * btnClose ,* btnAutometic ,* btnFlash ,*  btnMultiDoc;
    
    IBOutlet UIButton * btnCamera;
    
    IBOutlet UIActivityIndicatorView *activityIn;
...
@property (nonatomic ,retain) NSTimer *timerLabel;
...
@property (nonatomic ,retain) NSMutableArray *_Nullable arrMultiImages;

@property (nonatomic ) BOOL isMultiPages;
