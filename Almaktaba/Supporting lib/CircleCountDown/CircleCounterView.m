...
- (void)drawRect:(CGRect)rect {
    ...
    NSDictionary *attributes = @{NSFontAttributeName: [UIFont fontWithName:@"Courier-Bold" size:20.0f], NSForegroundColorAttributeName: [UIColor whiteColor] };
    CGSize sz  = [numberText sizeWithAttributes:attributes];
    [numberText drawInRect:CGRectInset(rect, (CGRectGetWidth(rect) - sz.width)/2.0f, (CGRectGetHeight(rect) - sz.height)/2.0f) withAttributes:attributes];
